...
export function __wbg_get_costcalculationinput_expected_priority_fee_lamports_per_tx(a: number): number;
export function __wbg_set_costcalculationinput_expected_priority_fee_lamports_per_tx(a: number, b: number): void;
...
export function __wbg_get_costcalculationinput_is_fallback_wallet_initialized(a: number): number;
export function __wbg_set_costcalculationinput_is_fallback_wallet_initialized(a: number, b: number): void;
...
export function costcalculationinput_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number): number;
