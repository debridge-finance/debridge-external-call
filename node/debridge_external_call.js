...
* @returns {string}
*/
module.exports.wallet_placeholder = function() {
    let deferred1_0;
    let deferred1_1;
    try {
...
* @returns {string}
*/
module.exports.auth_placeholder = function() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {string}
*/
module.exports.submission_placeholder = function() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
*/
module.exports.get_external_call_instructions = function(storage, current_external_call_offset, external_call_len) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
*/
module.exports.get_external_call_account_meta = function(storage, current_external_call_offset, external_call_len, count, submission_account, submission_auth_address, submission_wallet) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
module.exports.CostCalculationInput = CostCalculationInput;
/**
*/
...
/**
*/
class ExternalInstructionWrapper {
...
module.exports.ExternalInstructionWrapper = ExternalInstructionWrapper;
/**
*/
class ExternalInstructionWrapperIterator {
...
module.exports.ExternalInstructionWrapperIterator = ExternalInstructionWrapperIterator;
/**
*/
class ExternalInstructionWrapperWithPosition {
...
module.exports.ExternalInstructionWrapperWithPosition = ExternalInstructionWrapperWithPosition;
...
module.exports.__wbg_calculationerror_new = function(arg0) {
...
module.exports.__wbindgen_closure_wrapper279 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 78, __wbg_adapter_22);
    return addHeapObject(ret);
};

const path = require('path').join(__dirname, 'debridge_external_call_bg.wasm');
